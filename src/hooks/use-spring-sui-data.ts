...
import { LstData, SpringSuiData } from "@/types/spring-sui";
import { CoinMetadata } from "@mysten/sui/client";
import { isSendPointsS2, NORMALIZED_SEND_POINTS_S2_COINTYPE, NORMALIZED_SUI_COINTYPE } from "@/lib/coin-type";
...
export default function useFetchSpringSuiData() {
  ...
  const { data, mutate } = useSWR<SpringSuiData>("appData", dataFetcher, {
