...
//       <div
//         className={cn(
//           "flex w-full flex-col rounded-md bg-background p-4 transition-shadow",
//           !isReadOnly &&
...
//               autoFocus
//               type="number"
//               className="w-full py-1.5 font-sans bg-transparent text-h2 text-foreground placeholder:text-navy-500 focus-visible:outline-none md:text-h1 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
//               placeholder="0"
//               value={value}
//               readOnly={isReadOnly}
//               onChange={
