                    ...
                    <Card className='bg-secondary rounded-lg p-8 w-[480px]'>
                        <CardContent className="flex p-0 items-start gap-1">
                            <div className="flex flex-col">
                                <div className="text-base text-primary mb-2">Create Your Foam Account</div>
                                <div className="text-sm text-muted-foreground mb-4">To get started with Foam, we need to create a secure wallet for your account. This wallet will be used to manage your transactions and assets.</div>
